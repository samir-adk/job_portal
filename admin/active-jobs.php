            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  <li><a href="../admin_panel.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                  <li class="active"><a href="active-jobs.php"><i class="fa fa-briefcase"></i> Active Jobs</a></li>
                   <li class="active"><a href="applications.php"><i class="fa fa-briefcase"></i> Applications</a></li>
              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  ...
                  $fetch_data = "SELECT post.*, users.name AS username FROM post JOIN users ON post.post_user = users.user_id";
                      ...
                      <td><a href="view-job-post.php?id=<?php echo $row['id']; ?>"><i class="fa fa-address-card-o"></i></a></td>
                        <td><a href="delete-job-post.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash"></i></a></td>
                      </tr>  
                            <?php
                        }
                      }
